...
// Serve frontend - path relatif dari file server.js ini
// Di Railway: root dir = backend, jadi frontend ada di ../frontend/public
// Di lokal: sama
...
initSchema().then(() => { app.listen(PORT, () => console.log(`🚀 KontrakanKu running at http://localhost:${PORT}`)); }).catch(err => { console.error('❌ DB init failed:', err); process.exit(1); });
